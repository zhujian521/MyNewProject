...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        [NotificationCenter addObserver:self selector:@selector(textChange) name:UITextViewTextDidChangeNotification object:self];
    }
    return self;
}
- (void)textChange {
...
- (void)drawRect:(CGRect)rect {
    ...
    [self.placeholder drawInRect:placeRect withAttributes:dic];
}
